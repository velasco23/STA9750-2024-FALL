...
[Rank = (50 x (Avg Rating/10)) + (50 x (Number of Reviews/Max Reviews))]{style="color: cyan;"}
...
In the last decade, the horror genre has not seen a blockbuster hit, as seen in “Task 4 – Scatter Plot – Top 10 Genres in Recent Years”. Very few films managed to capture the public's eye in the same way as classics like "Silence of the Lambs." 
