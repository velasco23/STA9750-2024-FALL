...
[Motivation](Jorge%20website) 
[Strategies: Policies & Incentives](https://chrismontano129.github.io/STA9750-2024-FALL/courseproject.html) [Strategies: Adoption Barriers](Siddhi%20Website) 
[Metrics: Charger Infrastructure](Mussa%20Website) 
[Metrics: EV Adoption Trends](Haina%20website) [Conclusion](TBD%20Website)
...
#| warning: false
#| cache: true
#| code-summary: "SHPE USA"

library(dplyr)
library(sf)
library(httr)

# Base URL and file names
...
# Function to download and load shapefiles
download_and_load_shapefile <- function(file_name) {
  ...
  # Unzip the file
  unzip_dir <- file.path(download_dir, sub(".zip$", "", file_name))
  ...
  if (length(shp_file) > 0) {
    cat("Loading shapefile for", file_name, "\n")
    shapefile_data <- tryCatch({
      st_read(shp_file[1], quiet = TRUE)  # Load the first shapefile found
    }, error = function(e) {
      message("Error loading shapefile for ", file_name, ": ", e$message)
      return(NULL)
    })
    return(shapefile_data)
  } else {
    message("No shapefile found for ", file_name)
    return(NULL)
  }
}

# Loop through and download/load shapefiles
...
if (file.exists(shapefile_path)) {
  ...
  # Filter out Hawaii, Alaska, and other territories
  mainland_states <- us_states %>%
    filter(!NAME %in% c("Hawaii", "Alaska", "Puerto Rico", 
                        "United States Virgin Islands", 
                        "Commonwealth of the Northern Mariana Islands", 
                        "Guam", "American Samoa"))
  
  # Plot mainland USA with shapefiles overlay
  ggplot() +
    geom_sf(data = mainland_states, fill = "lightgrey", color = "white") +
    geom_sf(data = combined_shapefiles, fill = "blue", color = "black", alpha = 0.5) +
    labs(title = "US Congressional Districts and State Boundaries",
         caption = "Source: UCLA CD Maps & US Census Bureau") +
    theme_minimal()
} else {
  message("US States shapefile not found at the specified path.")
}
...
![Annual Emissions](C:/Users/velas/OneDrive/Documents/STA9750-2024-FALL/annual_emissions.png)
...
![Annual Emissions](C:/Users/velas/OneDrive/Documents/STA9750-2024-FALL/image2.png)



![Annual Emissions](C:/Users/velas/OneDrive/Documents/STA9750-2024-FALL/image3.png)
...
![Annual Emissions](C:/Users/velas/OneDrive/Documents/STA9750-2024-FALL/image4.png)
