...
## [1. Introduction]{style="color: blue;"}
...
## [2. Data Sources]{style="color: blue;"}
...
## [3. Data Cleaning and Pre-processing]{style="color: blue;"}
...
## [4. Data Exploration]{style="color: blue;"}
...
[Below is my attempt at recreating the electoral college votes for 2000. You can clearly see my limited experience with the R language through this graph. This graph is hard to digest because areas like Hawaii and Alaska skew the map and map it extremely hard to see the electoral votes in the main land.]{style="color: orange;"}
